...
The below is an explanation of the data that is retrieved from the [data.gov.sg](https://data.gov.sg) API endpoints. A full explanation is available on [Wikipedia](https://en.wikipedia.org/wiki/Pollutant_Standards_Index).
